...
func toTemplateResponse(t *templates.Template) templateResponse {
	return templateResponse{
		...
		ModelFilter: t.ModelFilter, AutoApply: t.AutoApply, CreatedAt: t.CreatedAt.Format(time.RFC3339),
	}
}
...
func (h *handler) createTemplate(w http.ResponseWriter, r *http.Request) {
	...
	t, err := h.templates.Create(r.Context(), req.Name, req.Description, req.Parameters, req.ModelFilter, req.AutoApply, operatorFromRequest(r))
	if err != nil {
	...
	if err := h.auditor.Record(r.Context(), operatorFromRequest(r), "", "ConfigTemplateCreated", map[string]any{
		"template_id": t.ID, "name": t.Name, "parameter_count": len(t.Parameters), "auto_apply": t.AutoApply,
	}); err != nil {
