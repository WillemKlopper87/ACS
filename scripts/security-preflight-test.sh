...
export ACS_API_PUBLIC_URL="https://api.acs.example.test"
...
expect_fail "plaintext API public origin" env ACS_API_PUBLIC_URL=http://api.acs.example.test bash "$PREFLIGHT"
