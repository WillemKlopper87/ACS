...
export interface AlertPolicy { id: string; name: string; scope: "fleet"|"tenant"|"group"|"device"; tenant_id?: string; group_id?: string; device_id?: string; customer_tier?: string; enabled: boolean; fault_priorities: Record<string,string>; offline_after: string|number; steps: Array<{after: string|number; destination: string; recipient: string}> }
